package com.breezeashoknotebooks.features.commondialogsinglebtn
...
import com.breezeashoknotebooks.app.domain.ShopVisitCompetetorModelEntity
import com.breezeashoknotebooks.app.domain.VisitRemarksEntity
...
import com.breezeashoknotebooks.features.addshop.presentation.ProspectListDialog
import com.breezeashoknotebooks.features.dashboard.presentation.DashboardActivity
import com.breezeashoknotebooks.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezeashoknotebooks.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezeashoknotebooks/files", "recorded_audio${System.currentTimeMillis()}.mp3")
