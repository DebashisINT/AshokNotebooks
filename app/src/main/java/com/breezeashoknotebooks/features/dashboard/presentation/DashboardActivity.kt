package com.breezeashoknotebooks.features.dashboard.presentation
...
import com.breezeashoknotebooks.*
import com.breezeashoknotebooks.R
import com.breezeashoknotebooks.app.*
import com.breezeashoknotebooks.app.NewFileUtils.browseDocuments
import com.breezeashoknotebooks.app.NewFileUtils.browsePDFDocuments
import com.breezeashoknotebooks.app.NewFileUtils.getExtension
import com.breezeashoknotebooks.app.domain.*
import com.breezeashoknotebooks.app.types.DashboardType
import com.breezeashoknotebooks.app.types.FragType
import com.breezeashoknotebooks.app.types.TopBarConfig
import com.breezeashoknotebooks.app.uiaction.DisplayAlert
import com.breezeashoknotebooks.app.utils.*
import com.breezeashoknotebooks.app.utils.AppUtils.Companion.isProfile
import com.breezeashoknotebooks.base.BaseResponse
import com.breezeashoknotebooks.base.presentation.BaseActivity
import com.breezeashoknotebooks.base.presentation.BaseFragment
import com.breezeashoknotebooks.features.NewQuotation.*
import com.breezeashoknotebooks.features.NewQuotation.api.GetQuotRegProvider
import com.breezeashoknotebooks.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezeashoknotebooks.features.SearchLocation.SearchLocationFragment
import com.breezeashoknotebooks.features.SearchLocation.locationInfoModel
import com.breezeashoknotebooks.features.TA.ViewAllTAListFragment
import com.breezeashoknotebooks.features.achievement.AchievementFragment
import com.breezeashoknotebooks.features.activities.presentation.*
import com.breezeashoknotebooks.features.addAttendence.*
import com.breezeashoknotebooks.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezeashoknotebooks.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezeashoknotebooks.features.addAttendence.model.GetReportToFCMResponse
import com.breezeashoknotebooks.features.addAttendence.model.GetReportToResponse
import com.breezeashoknotebooks.features.addAttendence.model.Leave_list_Response
import com.breezeashoknotebooks.features.addorder.presentation.AddOrderFragment
...
import com.breezeashoknotebooks.features.addshop.presentation.AddShopFragment
import com.breezeashoknotebooks.features.addshop.presentation.OTPVerificationDialog
import com.breezeashoknotebooks.features.addshop.presentation.ScanImageFragment
import com.breezeashoknotebooks.features.addshop.presentation.ShowCardDetailsDialog
import com.breezeashoknotebooks.features.alarm.model.AlarmData
import com.breezeashoknotebooks.features.alarm.presetation.AttendanceReportFragment
import com.breezeashoknotebooks.features.alarm.presetation.PerformanceReportFragment
import com.breezeashoknotebooks.features.alarm.presetation.VisitReportDetailsFragment
import com.breezeashoknotebooks.features.alarm.presetation.VisitReportFragment
import com.breezeashoknotebooks.features.attendance.AttendanceFragment
import com.breezeashoknotebooks.features.attendance.api.AttendanceRepositoryProvider
import com.breezeashoknotebooks.features.attendance.model.AttendanceRequest
import com.breezeashoknotebooks.features.attendance.model.AttendanceResponse
import com.breezeashoknotebooks.features.averageshop.presentation.AverageShopFragment
import com.breezeashoknotebooks.features.avgorder.presentation.AverageOrderFragment
import com.breezeashoknotebooks.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezeashoknotebooks.features.beatCustom.TeamBeatListFragment
import com.breezeashoknotebooks.features.billing.presentation.AddBillingFragment
import com.breezeashoknotebooks.features.billing.presentation.BillingDetailsFragment
import com.breezeashoknotebooks.features.billing.presentation.BillingListFragment
import com.breezeashoknotebooks.features.changepassword.presentation.ChangePasswordDialog
import com.breezeashoknotebooks.features.chat.model.ChatListDataModel
import com.breezeashoknotebooks.features.chat.model.ChatUserDataModel
import com.breezeashoknotebooks.features.chat.model.GroupUserDataModel
import com.breezeashoknotebooks.features.chat.presentation.*
import com.breezeashoknotebooks.features.chatbot.presentation.ChatBotFragment
import com.breezeashoknotebooks.features.chatbot.presentation.ChatBotShopListFragment
import com.breezeashoknotebooks.features.chatbot.presentation.ReportsFragment
import com.breezeashoknotebooks.features.chatbot.presentation.SelectLanguageDialog
import com.breezeashoknotebooks.features.commondialog.presentation.CommonDialog
import com.breezeashoknotebooks.features.commondialog.presentation.CommonDialogClickListener
import com.breezeashoknotebooks.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezeashoknotebooks.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezeashoknotebooks.features.commondialogsinglebtn.OnDialogClickListener
import com.breezeashoknotebooks.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezeashoknotebooks.features.contacts.ActivityDtlsFrag
import com.breezeashoknotebooks.features.contacts.AddOpptFrag
import com.breezeashoknotebooks.features.contacts.ContactDtls
import com.breezeashoknotebooks.features.contacts.ContactGr
import com.breezeashoknotebooks.features.contacts.ContactsAddFrag
import com.breezeashoknotebooks.features.contacts.ContactsFrag
import com.breezeashoknotebooks.features.contacts.SchedulerAddFormFrag
import com.breezeashoknotebooks.features.contacts.SchedulerViewFrag
import com.breezeashoknotebooks.features.contacts.TemplateAddFrag
import com.breezeashoknotebooks.features.contacts.TemplateViewFrag
import com.breezeashoknotebooks.features.contacts.ViewCrmOpptFrag
import com.breezeashoknotebooks.features.dailyPlan.prsentation.AllShopListFragment
import com.breezeashoknotebooks.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezeashoknotebooks.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezeashoknotebooks.features.damageProduct.ShopDamageProductListFrag
import com.breezeashoknotebooks.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezeashoknotebooks.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezeashoknotebooks.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezeashoknotebooks.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezeashoknotebooks.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezeashoknotebooks.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezeashoknotebooks.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezeashoknotebooks.features.dashboard.presentation.model.ContentListResponseModel
import com.breezeashoknotebooks.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezeashoknotebooks.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezeashoknotebooks.features.device_info.presentation.DeviceInfoListFragment
import com.breezeashoknotebooks.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezeashoknotebooks.features.document.DocumentRepoFeatureNewFragment
import com.breezeashoknotebooks.features.document.presentation.DocumentListFragment
import com.breezeashoknotebooks.features.document.presentation.DocumentTypeListFragment
import com.breezeashoknotebooks.features.document.presentation.OpenFileWebViewFragment
import com.breezeashoknotebooks.features.dymanicSection.presentation.AddDynamicFragment
import com.breezeashoknotebooks.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezeashoknotebooks.features.dymanicSection.presentation.DynamicListFragment
import com.breezeashoknotebooks.features.dymanicSection.presentation.EditDynamicFragment
import com.breezeashoknotebooks.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezeashoknotebooks.features.home.presentation.HomeFragment
import com.breezeashoknotebooks.features.homelocation.presentation.HomeLocationFragment
import com.breezeashoknotebooks.features.homelocation.presentation.HomeLocationMapFragment
import com.breezeashoknotebooks.features.know_your_state.KnowYourStateFragment
import com.breezeashoknotebooks.features.lead.LeadFrag
import com.breezeashoknotebooks.features.lead.ViewLeadFrag
import com.breezeashoknotebooks.features.leaderboard.LeaderBoardFrag
import com.breezeashoknotebooks.features.leaveapplynew.LeaveHome
import com.breezeashoknotebooks.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezeashoknotebooks.features.localshops.LocalShopListFragment
import com.breezeashoknotebooks.features.localshops.LocalShopListMapFragment
import com.breezeashoknotebooks.features.localshops.NearByShopsMapFragment
import com.breezeashoknotebooks.features.location.*
import com.breezeashoknotebooks.features.location.api.LocationRepoProvider
import com.breezeashoknotebooks.features.location.model.*
import com.breezeashoknotebooks.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezeashoknotebooks.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezeashoknotebooks.features.login.ShopFeedbackEntity
import com.breezeashoknotebooks.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezeashoknotebooks.features.login.presentation.LoginActivity
import com.breezeashoknotebooks.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezeashoknotebooks.features.logoutsync.presentation.LogoutSyncFragment
import com.breezeashoknotebooks.features.marketAssist.MarketAssistTabFrag
import com.breezeashoknotebooks.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezeashoknotebooks.features.marketAssist.ShopListMarketAssistFrag
import com.breezeashoknotebooks.features.marketing.presentation.MarketingPagerFragment
import com.breezeashoknotebooks.features.meetinglist.prsentation.MeetingListFragment
import com.breezeashoknotebooks.features.member.MapViewForTeamFrag
import com.breezeashoknotebooks.features.member.model.TeamLocDataModel
import com.breezeashoknotebooks.features.member.model.TeamShopListDataModel
import com.breezeashoknotebooks.features.member.presentation.*
import com.breezeashoknotebooks.features.menuBeat.MenuBeatFrag
import com.breezeashoknotebooks.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezeashoknotebooks.features.micro_learning.presentation.MicroLearningListFragment
import com.breezeashoknotebooks.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezeashoknotebooks.features.myallowancerequest.MyallowanceRequestFragment
import com.breezeashoknotebooks.features.myjobs.model.CustomerDataModel
import com.breezeashoknotebooks.features.myjobs.presentation.*
import com.breezeashoknotebooks.features.mylearning.MyLearningFragment
import com.breezeashoknotebooks.features.myorder.presentation.MyOrderListFragment
import com.breezeashoknotebooks.features.myprofile.presentation.MyProfileFragment
import com.breezeashoknotebooks.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezeashoknotebooks.features.nearbyshops.model.ShopData
import com.breezeashoknotebooks.features.nearbyshops.model.ShopListResponse
import com.breezeashoknotebooks.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezeashoknotebooks.features.nearbyshops.presentation.BeatListFragment
import com.breezeashoknotebooks.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezeashoknotebooks.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezeashoknotebooks.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezeashoknotebooks.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezeashoknotebooks.features.newcollection.CollectionDetailsStatusFragment
import com.breezeashoknotebooks.features.newcollection.CollectionShopListFragment
import com.breezeashoknotebooks.features.newcollection.NewCollectionListFragment
import com.breezeashoknotebooks.features.newcollectionreport.*
import com.breezeashoknotebooks.features.notification.NotificationFragment
import com.breezeashoknotebooks.features.orderITC.CartListFrag
import com.breezeashoknotebooks.features.orderITC.OrderListFrag
import com.breezeashoknotebooks.features.orderITC.ProductListFrag
import com.breezeashoknotebooks.features.orderITC.ViewNewOrdHisAllFrag
import com.breezeashoknotebooks.features.orderITC.ViewNewOrdHistoryFrag
import com.breezeashoknotebooks.features.orderITC.ViewOrdDtls
import com.breezeashoknotebooks.features.orderList.NewDateWiseOrderListFragment
import com.breezeashoknotebooks.features.orderList.NewOrderListFragment
import com.breezeashoknotebooks.features.orderList.OrderListFragment
import com.breezeashoknotebooks.features.orderdetail.presentation.OrderDetailFragment
import com.breezeashoknotebooks.features.orderhistory.ActivityMapFragment
import com.breezeashoknotebooks.features.orderhistory.OrderhistoryFragment
import com.breezeashoknotebooks.features.orderhistory.TimeLineFragment
import com.breezeashoknotebooks.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezeashoknotebooks.features.orderhistory.model.LocationData
import com.breezeashoknotebooks.features.pendinglocationinout.PendingOutLocationFrag
import com.breezeashoknotebooks.features.performance.GpsStatusFragment
import com.breezeashoknotebooks.features.performance.PerformanceFragment
import com.breezeashoknotebooks.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezeashoknotebooks.features.performance.model.UpdateGpsInputParamsModel
import com.breezeashoknotebooks.features.performanceAPP.OwnPerformanceFragment
import com.breezeashoknotebooks.features.performanceAPP.PerformanceAppFragment
import com.breezeashoknotebooks.features.performanceAPP.allPerformanceFrag
import com.breezeashoknotebooks.features.permissionList.ViewPermissionFragment
import com.breezeashoknotebooks.features.photoReg.*
import com.breezeashoknotebooks.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezeashoknotebooks.features.quotation.presentation.*
import com.breezeashoknotebooks.features.reimbursement.presentation.*
import com.breezeashoknotebooks.features.report.presentation.*
import com.breezeashoknotebooks.features.returnsOrder.*
import com.breezeashoknotebooks.features.settings.presentation.SettingsFragment
import com.breezeashoknotebooks.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezeashoknotebooks.features.shopdetail.presentation.*
import com.breezeashoknotebooks.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezeashoknotebooks.features.stock.StockDetailsFragment
import com.breezeashoknotebooks.features.stock.StockListFragment
import com.breezeashoknotebooks.features.stockAddCurrentStock.AddShopStockFragment
import com.breezeashoknotebooks.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezeashoknotebooks.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezeashoknotebooks.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezeashoknotebooks.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezeashoknotebooks.features.stockCompetetorStock.CompetetorStockFragment
import com.breezeashoknotebooks.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezeashoknotebooks.features.survey.SurveyFrag
import com.breezeashoknotebooks.features.survey.SurveyViewDtlsFrag
import com.breezeashoknotebooks.features.survey.SurveyViewFrag
import com.breezeashoknotebooks.features.task.presentation.AddTaskFragment
import com.breezeashoknotebooks.features.task.presentation.CalenderTaskFragment
import com.breezeashoknotebooks.features.task.presentation.EditTaskFragment
import com.breezeashoknotebooks.features.task.presentation.TaskListFragment
import com.breezeashoknotebooks.features.taskManagement.TaskManagementFrag
import com.breezeashoknotebooks.features.taskManagement.ViewTaskManagementFrag
import com.breezeashoknotebooks.features.timesheet.presentation.AddTimeSheetFragment
import com.breezeashoknotebooks.features.timesheet.presentation.EditTimeSheetFragment
import com.breezeashoknotebooks.features.timesheet.presentation.TimeSheetListFragment
import com.breezeashoknotebooks.features.viewAllOrder.CartFragment
import com.breezeashoknotebooks.features.viewAllOrder.OrderTypeListFragment
import com.breezeashoknotebooks.features.viewAllOrder.ViewAllOrderListFragment
import com.breezeashoknotebooks.features.viewAllOrder.ViewCartFragment
import com.breezeashoknotebooks.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezeashoknotebooks.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezeashoknotebooks.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezeashoknotebooks.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezeashoknotebooks.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezeashoknotebooks.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezeashoknotebooks.features.viewPPDDStock.ViewOutstandingFragment
import com.breezeashoknotebooks.features.viewPPDDStock.ViewPPDDListFragment
import com.breezeashoknotebooks.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezeashoknotebooks.features.viewPPDDStock.ViewStockFragment
import com.breezeashoknotebooks.features.weather.presentation.WeatherFragment
import com.breezeashoknotebooks.mappackage.MapActivity
import com.breezeashoknotebooks.mappackage.MapActivityWithoutPath
import com.breezeashoknotebooks.mappackage.SendBrod
import com.breezeashoknotebooks.widgets.AppCustomEditText
import com.breezeashoknotebooks.widgets.AppCustomTextView
...
import com.breezeashoknotebooks.features.login.api.opportunity.OpportunityRepoProvider
import com.breezeashoknotebooks.features.login.model.NewSettingsResponseModel
import com.breezeashoknotebooks.features.mylearning.AllTopicsWiseContents
import com.breezeashoknotebooks.features.mylearning.BookmarkFetchResponse
import com.breezeashoknotebooks.features.mylearning.BookmarkFrag
import com.breezeashoknotebooks.features.mylearning.BookmarkPlayFrag
import com.breezeashoknotebooks.features.mylearning.KnowledgeHubAllVideoList
import com.breezeashoknotebooks.features.mylearning.LeaderboardLmsFrag
import com.breezeashoknotebooks.features.mylearning.LmsQuestionAnswerSet
import com.breezeashoknotebooks.features.mylearning.MyLearningAllVideoList
import com.breezeashoknotebooks.features.mylearning.MyLearningTopicList
import com.breezeashoknotebooks.features.mylearning.MyLearningVideoPlay
import com.breezeashoknotebooks.features.mylearning.MyPerformanceFrag
import com.breezeashoknotebooks.features.mylearning.MyTopicsWiseContents
import com.breezeashoknotebooks.features.mylearning.NotificationLMSFragment
import com.breezeashoknotebooks.features.mylearning.SearchLmsFrag
import com.breezeashoknotebooks.features.mylearning.SearchLmsKnowledgeFrag
import com.breezeashoknotebooks.features.mylearning.SearchLmsLearningFrag
import com.breezeashoknotebooks.features.mylearning.VideoPlayLMS
import com.breezeashoknotebooks.features.mylearning.apiCall.LMSRepoProvider
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezeashoknotebookslogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeashoknotebookslogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezeashoknotebooks/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezeashoknotebookslogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezeashoknotebookslogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezeashoknotebookslogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
