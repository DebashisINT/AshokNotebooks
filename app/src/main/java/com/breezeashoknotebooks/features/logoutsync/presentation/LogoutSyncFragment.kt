package com.breezeashoknotebooks.features.logoutsync.presentation
...
import com.breezeashoknotebooks.CustomConstants


import com.breezeashoknotebooks.R
import com.breezeashoknotebooks.app.AppDatabase
...
import com.breezeashoknotebooks.app.utils.Toaster
import com.breezeashoknotebooks.base.BaseResponse
import com.breezeashoknotebooks.base.presentation.BaseActivity
import com.breezeashoknotebooks.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezeashoknotebooks.features.billing.api.AddBillingRepoProvider
import com.breezeashoknotebooks.features.billing.model.AddBillingInputParamsModel
...
import com.breezeashoknotebooks.features.dashboard.presentation.ReasonDialog
...
import com.breezeashoknotebooks.features.document.model.AddEditDocumentInputParams
import com.breezeashoknotebooks.features.document.model.DocumentAttachmentModel
...
import com.breezeashoknotebooks.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezeashoknotebooks.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezeashoknotebooks.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezeashoknotebooks.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezeashoknotebooks.features.orderhistory.model.*
...
import com.breezeashoknotebooks.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezeashoknotebooks.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezeashoknotebooks.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezeashoknotebooks.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezeashoknotebooks.features.timesheet.model.AddTimeSheetInputModel
import com.breezeashoknotebooks.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezeashoknotebooks.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezeashoknotebooks.features.viewAllOrder.model.AddOrderInputProductList
import com.breezeashoknotebooks.mappackage.SendBrod
import com.breezeashoknotebooks.widgets.AppCustomTextView
import com.breezeashoknotebooks.MonitorService
import com.breezeashoknotebooks.MySingleton
import com.breezeashoknotebooks.app.AlarmReceiver
...
import com.breezeashoknotebooks.features.addshop.presentation.ShopExtraContactReq
...
import com.breezeashoknotebooks.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezeashoknotebooks.features.login.model.GetConcurrentUserResponse
...
import com.breezeashoknotebooks.features.orderITC.SyncDeleteOpptL
import com.breezeashoknotebooks.features.orderITC.SyncEditOppt
import com.breezeashoknotebooks.features.orderITC.SyncOppt
import com.breezeashoknotebooks.features.orderITC.SyncOpptProductL
import com.breezeashoknotebooks.features.orderITC.SyncOrd
import com.breezeashoknotebooks.features.orderITC.SyncOrdProductL
import com.breezeashoknotebooks.features.performance.model.Gps_status_list
import com.breezeashoknotebooks.features.performance.model.UpdateGpsInputListParamsModel
import com.breezeashoknotebooks.features.returnsOrder.ReturnProductList
import com.breezeashoknotebooks.features.returnsOrder.ReturnRequest
import com.breezeashoknotebooks.features.viewAllOrder.model.NewOrderSaveApiModel
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezeashoknotebooks/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeashoknotebookslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeashoknotebookslogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeashoknotebookslogsample/log.zip").path);
