package com.breezeashoknotebooks.features.nearbyshops.presentation
...
import com.breezeashoknotebooks.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezeashoknotebooks.app.utils.FTStorageUtils
import com.breezeashoknotebooks.app.utils.NotificationUtils
...
import com.breezeashoknotebooks.features.addshop.model.AssignedToShopListResponseModel
import com.breezeashoknotebooks.features.addshop.model.QuestionSubmit
import com.breezeashoknotebooks.features.addshop.model.UpdateAddrReq
import com.breezeashoknotebooks.features.addshop.model.UpdateAddressShop
...
import com.breezeashoknotebooks.features.addshop.presentation.*
...
import com.breezeashoknotebooks.features.location.model.ShopDurationRequestData
...
import com.breezeashoknotebooks.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezeashoknotebooks.features.marketing.model.MarketingCategoryListResponse
...
import com.breezeashoknotebooks.features.nearbyshops.model.StageListResponseModel
...
import com.breezeashoknotebooks.features.shopdetail.presentation.AddCollectionDialog
...
import com.breezeashoknotebooks.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezeashoknotebooksApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
